...
/******************************************************************************************************/
		...
		#define USART_TX_BUFFER_SIZE     400              //USART BUFFER FIFO SIZE
		#define USART_RX_BUFFER_SIZE     400              //USART BUFFER FIFO SIZE
...
/**
 ...
 /**
   *@breif A USART driver class for STM32F103 series
   *
   */
class USART
{
